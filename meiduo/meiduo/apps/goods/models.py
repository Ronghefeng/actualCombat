...
class Brand(BaseModel):
    """
    品牌
    注意：使用 ImageField 需要县安装 Pillow 模块，python -m pip install Pillow
    """
...
class Goods(BaseModel):
    ...
    # 富文本字段
    # RichTextUploadingField 可支持上传图片
    # RichTextField 仅支持修改
    desc_detial = RichTextUploadingField(default='', verbose_name='详细介绍')
